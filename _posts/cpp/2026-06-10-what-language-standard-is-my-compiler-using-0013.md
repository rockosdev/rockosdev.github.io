...
* 检查IDE设置，确保编译器配置为使用预期语言标准。详见[0.12节——配置编译器：选择语言标准]({% link _posts/cpp/2026-05-17-configuring-your-compiler-choosing-a-language-standard-0012.md %})，了解主流编译器的具体操作方法。确保配置文件无拼写或格式错误。部分编译器需为每个项目单独设置语言标准而非全局配置，若您刚创建新项目则可能属于此情况。
